...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
  <div class="bg-gray-800 rounded-2xl shadow-2xl p-8 w-full max-w-md">
    <h1 class="text-3xl font-bold text-center mb-6 text-green-400">Create an Account</h1>
    ...
    <form action="<?= site_url('auth/register') ?>" method="post" class="space-y-4">
      ...
      <div>
        <label class="block text-sm font-medium text-white-700">Role</label>
        <select name="role"
                class="w-full px-4 py-3 rounded-lg bg-gray-700 border border-gray-600 focus:ring-2 focus:ring-green-400 outline-none">
    ...
    <p class="text-sm text-gray-400 mt-6 text-center">
      ...
      <a href="<?= site_url('auth/login') ?>" class="text-green-400 hover:underline">Log In</a>
    </p>
  </div>
</body>
</html>
